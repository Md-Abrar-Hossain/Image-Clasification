...
![Class distribution across splits](class_distribution.png)

### Sample Images

![Sample training images, NORMAL top, PNEUMONIA bottom](sample_images.png)

## Exploratory Data Analysis

**Pixel intensity distributions** — NORMAL vs. PNEUMONIA pixel value histograms:

![Pixel intensity comparison](pixel_histograms.png)

**Mean and standard deviation images per class** — the "average" X-ray for each class, and pixel-wise variability:

![Mean and std dev images per class](mean_std_images.png)

**Brightness vs. contrast** — per-image mean pixel value vs. pixel std deviation:

![Brightness vs contrast per image](brightness_contrast.png)
...
![Augmentation examples](augmented_samples.png)
...
![Training curves: accuracy, loss, AUC](training_curves.png)
...
├── training_curves.png          # Accuracy / loss / AUC vs. epoch
